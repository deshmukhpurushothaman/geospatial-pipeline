...
Revision ID: 50106c6b2a0a
Revises: 
Create Date: 2024-12-04 11:24:31.256821
...
def upgrade() -> None:
    ...
    sa.Column('geom', geo_types.Geometry(from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
    sa.Column('properties', sa.JSON(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_tiles_geom', 'tiles', ['geom'], unique=False, postgresql_using='gist')
...
def downgrade() -> None:
    ...
    op.drop_index('idx_tiles_geom', table_name='tiles', postgresql_using='gist')
    op.drop_table('tiles')
    # ### end Alembic commands ###
